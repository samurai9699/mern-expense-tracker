...
const categoryColorMap = {
	saving: "from-yellow-600 via-orange-500 to-yellow-400",
	expense: "from-indigo-600 via-purple-500 to-indigo-400",
	investment: "from-teal-600 via-green-500 to-teal-40",
